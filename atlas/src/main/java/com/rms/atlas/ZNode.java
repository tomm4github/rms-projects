...
/**
 * This shows a very simplified method of registering an instance with the discovery service. Each individual
 ...
 */
public class ZNode implements Closeable
{
    private final ServiceDiscovery<InstanceDetails> serviceDiscovery;
    private final ServiceInstance<InstanceDetails> thisInstance;

    public ZNode(CuratorFramework client, String path, String serviceName, String description) throws Exception
    {
