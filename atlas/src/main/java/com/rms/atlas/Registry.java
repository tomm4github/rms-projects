...
public class Registry {
	...
	private static void processCommands(
		...
		List<ZNode> servers = Lists.newArrayList();
		try {
	...
	private static void deleteInstance(String[] args, String command,
		...
		ZNode server = Iterables.find(servers,
				new Predicate<ZNode>() {
					
					public boolean apply(ZNode server) {
	...
	private static void addInstance(String[] args, CuratorFramework client,
			String command, List<ZNode> servers) throws Exception {
		...
		String serviceName = args[0];
		ZNode server = new ZNode(client, PATH, serviceName,
